...
class NeakasaApiClient:
    ...
    async def add_cat(self, device_name, user_id, cat_data):
        # POST /api/catbox/cat
        pass

    async def update_cat(self, device_name, user_id, cat_data):
        # POST /api/catbox/cat/update
        pass

    async def delete_cat(self, device_name, user_id, cat_id):
        # POST /api/catbox/cat/delete
        pass

    async def get_cat_activity(self, device_name, user_id, start_time, end_time):
        # GET /api/catbox/record
        pass

    async def get_cat_statistics(self, device_name, user_id, cat_id, start_time, end_time, zone):
        # GET /api/catbox/toilet/statistics
        pass
